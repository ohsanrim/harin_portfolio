	...
	<div id="viewheader">
		<div class="background">
			<div class="backgroundImg"
				style="background: url('<%=request.getContextPath()%>/resources/myblog/images/${backgroundImg}') no-repeat 50% 50%; background-size: cover;">
			</div>
		...
		<div class="subjectbackground">
			<div class="blogSubjectWrapper">
				...
				<div class="userinfowrapper">
					<img class="view_userImg" src="<%=request.getContextPath()%>/resources/myblog/images/${memberDTO.image }">
