...
<html>
  <head>
    ...
    <link href="<%=request.getContextPath()%>/resources/myblog/css/styles1.css" rel="stylesheet" />
  ...
  <body>
    ...
    <div id="mypageHeadder">
      <div class="backgroundImg" style="background: url(<%=request.getContextPath()%>/resources/myblog/images/${memberDTO.backimage}) no-repeat 50% 50%; background-size: cover;">
      </div>
      <div class="layer">
      </div>
    </div>
   <div class="profileImg_wrapper">
      <div class="profileCircle">
        <div class="userProfile">
          <img class="userProfileImg" src="<%=request.getContextPath()%>/resources/myblog/images/${memberDTO.image}" style="width:100%; height:100%;">
        </div>
      </div>
      <div class="userId">
        <%-- ${memberDTO.nickname} --%>
    ...
    <input type="hidden" id="pageNickname" value="뚜르라기">
    <input type="hidden" id="pageEmail" value="ka28@naver.com">
    <input type="hidden" id="sessionEmail" value="ka28@naver.com">
    <input type="hidden" id="nickname" value="Ohsanrim">
  <!--content -->
        ...
        <div class="modal-body">
				     <div class="imgInput">
	                    ...
	                    <div class="userChoiceImg">
	                    	<img id="bgImg" src="<%=request.getContextPath()%>/resources/myblog/images/basicUserImage.png" style="width:100%; height:100%;"/>
	                    </div>
  ...
  <!-- Core theme JS-->
  <script src="<%=request.getContextPath()%>/resources/myblog/js/scripts.js"></script>
