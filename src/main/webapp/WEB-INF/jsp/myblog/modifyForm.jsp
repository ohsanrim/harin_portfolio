...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/myblog/css/view.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/myblog/css/modifyForm.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/myblog/css/hover.css">
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/myblog/js/summernote-map-plugin-master/summernote-map-plugin.js"></script>
	...
	<div id="viewheader">
		<div class="background">
			<div class="backgroundImg"
				style="background: url('<%=request.getContextPath()%>/resources/myblog/images/${myblogDTO.mainimage}') no-repeat 50% 50%; background-size: cover;">s
			</div>
		...
		<div class="subjectbackground">
			<div class="blogSubjectWrapper">
				...
				<div class="userinfowrapper">
					<img class="view_userImg" src="<%=request.getContextPath()%>/resources/myblog/images/pic01.jpg">
					...
					<div class="modal-body">
						<div class="imgInput">
							...
							<div class="userChoiceImg">
								<img id="bgImg" src="<%=request.getContextPath()%>/resources/myblog/images/basicUserImage.png"
...
<script src="<%=request.getContextPath()%>/resources/myblog/js/view.js"></script>
<script src="<%=request.getContextPath()%>/resources/myblog/js/writeBlog.js"></script>
<script src="<%=request.getContextPath()%>/resources/myblog/js/modifyForm.js"></script>
</html>
