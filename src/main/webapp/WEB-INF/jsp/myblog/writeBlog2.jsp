...
<link href="<%=request.getContextPath()%>/resources/myblog/css/step4.css" rel="stylesheet" />
...
<script src="<%=request.getContextPath()%>/resources/myblog/js/writeBlog2.js"></script>s
</html>
